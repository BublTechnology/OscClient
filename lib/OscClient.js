...
var OscClient = function (domainArg, portArg) {
  ...
  this.checkForUpdates = function (stateFingerprint, waitTimeout) {
    return makeHttpRequest('POST', checkForUpdatesUrl, this.applicationJsonType, { stateFingerprint: stateFingerprint, waitTimeout: waitTimeout })
  }
  ...
  this.listImages = function (entryCount, includeThumb, maxSize, continuationToken) {
    return commandsExecute.apply(this, ['camera.listImages', { entryCount: entryCount, includeThumb: includeThumb, maxSize: maxSize, continuationToken: continuationToken }])
  }
